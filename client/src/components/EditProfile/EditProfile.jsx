                ...
                <div class="row">
                    <div class="col-xl-4">
                        <div class="card mb-4 mb-xl-0">
                            <div style={{backgroundColor:"#313638",color:"white"}} class="card-healer">Profile picture</div>
                            <div class="card-body text-center">
                                ...
                                <div className='upload-btn-div'>
                                    <button style={{backgroundColor: "#313638"}} class="btn btn-success" type="button">
                                        <div className='inputFile'>
                                            <FileBase64 multiple={false} onDone={({base64}) => setData({...data,profilePic: base64})} ref={inputRef} onClick={fileOpen}/>
                                        </div>
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-8">
                        <div class="card mb-4">
                            <div style={{backgroundColor:"#313638",color:"white"}} class="card-healer">Account Details</div>
                            <div class="card-body">
                                <form method="patch">
                                    <div class="mb-3">
                                        <label class="small mb-1" for="inputUsername">Username (How your name will appear to other users on this site)</label>
                                    ...
                                    <div class="row gx-3 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input onChange={change} name='twitter' class='form-control' id="inputFirstName" type="text" placeholder="Enter Twitter URL" value={data.twitter}/>
                                        </div>
                                    </div>
                                    <div class="row gx-3 mb-3">
                                        <div class="col-md-6">
