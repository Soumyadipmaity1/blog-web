        ...
        if(followers.length === 0) {
            ...
            followers.map(async(e, index) => {
                if(index < followers.length) {
                    ...
                    setFollowersProf([...userFollowings])
                    setFollowerSpinner(false)
                }
                else {
                    return;
    ...
    return (
        ...
        <div>
                                    ...
                                    <div style={{display: followingSpinner ? "none" : "block"}} className='main-container'>
                                        <div className='following-container'>
                                            <div className='imageFlex'>
                                                ...
                                                src={e.profilePic != null ? e.profilePic : defaultprofile} alt=""
                                                />
                                                <div className='fflex'>
            ...
            >
                <Box sc={style}>
                    <Typography
                        style={{ fontWeight: "600", fontSize: "14px", borderBottom: "1px solid #dbdbdb", paddingTop: "14px", paddingBottom: "10px", paddingBottom: "10px", letterSpacing: "0.4px" }} className="text-center" id="modal-modal-title" variant="h6" component="h2"
                    >
                        Followers
                    </Typography>
                    <div style={{display: followerSpinner ? "block" : "none"}}
                         className='fSpinner'>
                            <lottie-player 
                            className="following-spinner" 
                            src="https://assets8.lottiefiles.com/packages/lf20_ncEPzlAWGW.json" 
                                        ...
                                        <div style={{display: followerSpinner ? "none" : "block"}} className='main-container'>
                                            <div className='following-container'>
                                                <div className='imageFlex'>
                                                    <img 
                                                    className = 'followingProfile'
                                                    src = {e.profilePic != null ? e.profilePic : defaultprofile}
        ...
        <div style = {{display : loading ? "none" : "block"}} className = 'profile-container'>
            <div className = 'profile-section'>
                <button style = {{userSelect : "none"}}> {/*sets CSS property to null for user selection */}
                ...
                <div className = 'profile-info'>
                    ...
                    <div style={{display: (user.instagram || user.linkedin || user.facebook || user.twitter) ? "block" : "none"}} className = 'social-links'>
                        ...
                        <div className = 'social-flex'>
                            <a style={{display: user.instagram ? "block" : "none"}} target = "_blank" href = {user.instagram}>
                                <AiFillInstagram className = 'share-icon-lg'/>
                            </a>

                            <a style={{display: user.twitter ? "block" : "none"}} target = "_blank" href = {user.twitter}>
                                <AiFillTwitterCircle className='share-icon-lg'/>
                            </a>

                            <a style={{display: user.facebook ? "block" : "none"}} target = "_blank" href = {user.facebook}>
                                <BsFacebook className='share-icon-lg'/>
                            </a>

                            <a style={{display: user.linkedin ? "block" : "none"}} target = "_blank" href = {user.linkedin}>
                ...
                ?
                    ...
                    ?
                        <h3 className='featured'>
                            <span className='backgroundColor'>&nbsp;Read</span>
                            &nbsp;Author Blogs
                        </h3>
                    :
                        <h3 className='featured'>
                            <span className='backgroundColor'>&nbsp;My</span>
                            &nbsp;Blogs
                        </h3>
                :
                    <div className='noPostFlex'>
                        ...
                        <h3 className='featured'>
                            <span className='backgroundColor'>&nbsp;No Blogs</span>
                            &nbsp;Yet
                        </h3>
                    </div>
