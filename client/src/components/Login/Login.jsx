...
function Login() {
    ...
    return (
        <>
        <div className='login-page' onClick={() => setErrorExists(false)}>
            <form className='container login-card'>
                ...
                <div className='mb-3'>
                    <label style={{color: "rgba(34, 34, 34, 1)"}} htmlFor='exampleInputEmail1' className='form-label'>
                        Email address
                    </label>
                ...
                <p className='noaccount text-center mt-3'>Don't have an Account?
